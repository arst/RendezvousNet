...
{
    /// <summary>
    ///     Implements rendezvous hashing (also known as highest random weight (HRW) hashing) with xxHash as hashing
    ///     function(better distribution, worse performance).
    /// </summary>
    public class RendezvousHashXxH64<TKey, TNode> : RendezvousHashBase<TKey, TNode>
